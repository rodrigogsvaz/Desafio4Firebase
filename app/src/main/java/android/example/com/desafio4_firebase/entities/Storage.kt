...
class Storage (var gameTile : Game?) {
    ...
    fun getInstances() : MutableLiveData<MutableList<Game>> {

        var gameMap =  MutableLiveData<MutableList<Game>>()
        var gamelistaux : MutableList<Game> = arrayListOf()
